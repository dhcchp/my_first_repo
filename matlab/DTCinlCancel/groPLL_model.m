...
settle_sample = 20e5; % The unit is in CKV cycles.
...
step_DCO = 0;
I_path = 0;
yiir1 = 0; yiir2 = 0; yiir3 = 0; yiir4 = 0;lambda1 = 1/2^2;lambda2 = 1/2^2;lambda3=1/2^1;lambda4=1/2^1;
...
for step = 1:Sim_Time    
    ...
    trise(step) = -1*(tR(step) - tckv(step_DCO));    
    Tv_est = Tv;
