...
% Version 1.0, Peng CHEN, 2021.12.02
...
step_DCO = 0;
I_path = 0;
yiir1 = 0; yiir2 = 0; yiir3 = 0; yiir4 = 0;lambda1 = 1/2^2;lambda2 = 1/2^2;lambda3=1/2^2;lambda4=1/2^1;
accum_QE = 0;
tTDC_residue = 0;
...
for step = 1:Sim_Time    
    ...
    trise(step) = -1*(tR(step) - tckv(step_DCO) - 1*tTDC_residue);    
    Tv_est = Tv;
    ...
    NC = accum_QE * gain_nc; %ideal calibration gain estimation
    phie(step) =  epsilon(step)-1*NC;
    
    gain_nc = gain_nc + 2 * 1e-4 * phie(step) * NC;
