...
% Version 1.0, Peng CHEN, 2021.12.01

%% Initial Parameter Settings
clc;clear;close all;
Sim_Time = 2^20; % The number is in FREF cycles.
...
for step = 1:Sim_Time    
    ...
    trise(step) = -1*(tR(step) - tckv(step_DCO) - tTDC_residue);    
    Tv_est = Tv;
    ...
    NC = accum_QE * 1.0; %ideal calibration gain estimation
    phie(step) =  epsilon(step)-NC;
